  ...
  return (
    <section className="space-y-5 lg:flex justify-center items-center gap-10">
      <article className="flex flex-col gap-2 items-start lg:gap-4">
        <span className="font-black text-[50px] leading-[1.1]">
        ...
        <Link
          to="/contacto/"
          className="bg-unterbau-dark text-unterbau-white rounded-full px-5 py-1.5 font-bold text-[15px]"
        >
          Habla con nosotros
        </Link>
      </article>
      <article className="lg:w-[50%] flex justify-center">
        <img
          ...
          className="rounded-[20px] w-[333px] h-[480px] object-cover object-right"
        />
      </article>
    </section>
  )
