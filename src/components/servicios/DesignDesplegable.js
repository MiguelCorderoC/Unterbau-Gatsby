    ...
    <>
      <article className="space-y-3">
        <div className="flex items-center justify-between lg:gap-5">
          <span className="text-3xl lg:text-5xl lg:text-nowrap">{titulo}</span>
          <div className="lg:flex items-center justify-end gap-5">
            <p className="hidden lg:block lg:w-2/3">{texto}</p>
            <button
              onClick={() => {
                setVisible(prev => !prev)
              }}
              className="p-2 bg-unterbau-dark text-unterbau-white rounded-full flex justify-center items-center"
            >
