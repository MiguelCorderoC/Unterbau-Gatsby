...
export const ChildrenDesplegable = ({ arrayList = [] }) => {
  return (
    <article className="space-y-5">
      <div className="border-b-2 pb-5 border-dashed"></div>
      {arrayList.map((categoria, index) => (
        <div
          key={index}
          className="flex border-b-2 pb-5 border-dashed lg:items-center lg:pb-5"
        >
          ...
          <div className="ml-5 w-full lg:flex lg:justify-between  lg:items-center">
            ...
            <ul className="lg:flex lg:justify-start lg:gap-8  lg:w-[70%] w-full items-center space-y-3 lg:space-y-0 font-museo font-light text-[15px]">
